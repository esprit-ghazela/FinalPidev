...
public class Reclamation {
    ...
    public Reclamation(int id_reclamation, String reclamation, int categorie, String nom, String prenom, String date, int etat) {
    ...
    public Reclamation(int id_reclamation, String reclamation, int categorie, String nom, String prenom, String date) {
        this.id_reclamation = id_reclamation;
        this.reclamation = reclamation;
        this.categorie = categorie;
        this.nom = nom;
    ...
    public Reclamation(String reclamation, int categorie, String nom, String prenom, String date) {
        this.reclamation = reclamation;
        this.categorie = categorie;
        this.nom = nom;
        this.prenom = prenom;
