...
public class Produit {
    ...
    public Produit(int id, String nom, double prix, int quantite, String reference, String image) {
        this.id = id;
        this.nom = nom;
        this.prix = prix;
    ...
    public String getCaegorie() {
        return caegorie;
    }

    public void setCaegorie(String caegorie) {
