 ...
 * @author Ahmed laifi
 */
public class afficheClubClientTrier extends Form{
    Form current;
   ...
   public afficheClubClientTrier(Form previous) {
      current=this;
...
/***********************************************************************************/
         ...
         ArrayList<Club> liste=ClubService.getInstance().getAllclubtrier();
