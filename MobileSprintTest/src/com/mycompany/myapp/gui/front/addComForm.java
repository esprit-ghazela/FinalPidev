 ...
 * @author aziz khbou
 */
public class addComForm extends BaseForm {
    ...
    getTitleArea().setUIID("Container");
        ...
        getToolbar().addMaterialCommandToLeftBar("back", 
                FontImage.MATERIAL_BACKUP, ev->{new panierForm().show();});
        ...
        if (listPanier.size() == 0) {
            ...
            Button pac = new Button("Vers Paiement");
    ...
    private Component createContainer(Panier c1) {
        ...
        int prixt = (int) c1.getPrix();
        int tot = prixt + livr;
        String prod = c1.getNom();
    ...
    TextField tprod = new TextField("", "Produit", 20, TextArea.ANY);
